...
public:
    ...
    void bm_recovery_end(::google::protobuf::RpcController* controller,
                       ...
                       ::google::protobuf::Closure* done);
    void bm_leader_transfer_start(::google::protobuf::RpcController* controller,
                       const ::braft::BmLeaderTransferStartRequest* request,
                       ::braft::BmLeaderTransferStartResponse* response,
                       ::google::protobuf::Closure* done);
private:
