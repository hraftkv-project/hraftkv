...
// RS-Raft
void RaftServiceImpl::collect_fragment(::google::protobuf::RpcController* controller,
                          const ::braft::CollectFragmentRequest* request,
                          ::braft::CollectFragmentResponse* response,
                          ::google::protobuf::Closure* done) {
}
