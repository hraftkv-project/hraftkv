...
public:
    ...
    LogManager();
    virtual BRAFT_MOCK ~LogManager();
    virtual int init(const LogManagerOptions& options);
    ...
    virtual void set_applied_id(const LogId& applied_id);
    ...
    // UniRaft - allow getting the lastest append entries latency
    bvar::LatencyRecorder& get_storage_append_entries_latency();
    bvar::IntRecorder& get_storage_append_entries_written_size();
